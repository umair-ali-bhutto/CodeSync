...
public class DashboardSummary {
	...
	public DashboardSummary(long todayRequests, long yesterdayRequests, long activeClientsToday,
			long activeClientsYesterday) {
	...
	public long getYesterdayRequests() {
		return yesterdayRequests;
	}
	...
	public long getActiveClientsYesterday() {
		return activeClientsYesterday;
	}
}